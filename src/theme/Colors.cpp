...
void ApplyColors(ImGuiStyle& style, const Palette& palette) {
    ...
    colors[ImGuiCol_FrameBgActive]         = ImVec4(palette.bgElevated.x + 0.04f, palette.bgElevated.y + 0.04f, palette.bgElevated.z + 0.04f, 1.00f);

    // Title bars
    colors[ImGuiCol_TitleBg]               = palette.bgBase;
    colors[ImGuiCol_TitleBgActive]         = palette.bgBase;
    ...
    colors[ImGuiCol_ScrollbarGrabHovered]  = palette.accentActive;
    colors[ImGuiCol_ScrollbarGrabActive]   = palette.accent;

    // Checks and sliders
    colors[ImGuiCol_CheckMark]             = palette.accent;
    colors[ImGuiCol_SliderGrab]            = palette.accentActive;
    ...
    // Headers (collapsing headers, tree nodes, table headers, outliner rows)
    colors[ImGuiCol_Header]                = palette.bgHeader;
    colors[ImGuiCol_HeaderHovered]         = palette.bgElevated;
    colors[ImGuiCol_HeaderActive]          = ImVec4(palette.accent.x, palette.accent.y, palette.accent.z, 0.25f);
    ...
    // Tabs — dark default, subtle hover, active shows panel bg
    colors[ImGuiCol_Tab]                   = palette.bgBase;
    colors[ImGuiCol_TabHovered]            = palette.bgHeader;
    colors[ImGuiCol_TabActive]             = palette.bgPanel;
    colors[ImGuiCol_TabUnfocused]          = palette.bgBase;
    colors[ImGuiCol_TabUnfocusedActive]    = palette.bgPanel;

    // Docking
    colors[ImGuiCol_DockingPreview]        = ImVec4(palette.accent.x, palette.accent.y, palette.accent.z, 0.25f);
    ...
    colors[ImGuiCol_TableBorderLight]      = palette.borderSubtle;
    colors[ImGuiCol_TableRowBg]            = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
    colors[ImGuiCol_TableRowBgAlt]         = ImVec4(1.00f, 1.00f, 1.00f, 0.015f);

    // Selection and navigation
    colors[ImGuiCol_TextSelectedBg]        = ImVec4(palette.accent.x, palette.accent.y, palette.accent.z, 0.20f);
